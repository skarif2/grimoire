...
- `.desk/` ephemeral, per worktree, gitignored, always available. Holds `plan.md`, `review.md`, `pr.md`, `handoffs/`. Per worktree, so `plan.md` always means the current branch.
